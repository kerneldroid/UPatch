...
import me.bmax.upatch.ui.WebUIActivity
import me.bmax.upatch.ui.component.ConfirmResult
import me.bmax.upatch.ui.component.ModuleRemoveButton
import me.bmax.upatch.ui.component.ModuleStateIndicator
import me.bmax.upatch.ui.component.ModuleUndoRemoveButton
import me.bmax.upatch.ui.component.ModuleUpdateButton
import me.bmax.upatch.ui.component.SearchAppBar
import me.bmax.upatch.ui.component.WarningCard
import me.bmax.upatch.ui.component.pinnedScrollBehavior
import me.bmax.upatch.ui.component.rememberConfirmDialog
import me.bmax.upatch.ui.component.rememberLoadingDialog
import me.bmax.upatch.ui.viewmodel.APModuleViewModel
import me.bmax.upatch.util.DownloadListener
import me.bmax.upatch.util.download
import me.bmax.upatch.util.hasMagisk
import me.bmax.upatch.util.reboot
import me.bmax.upatch.util.toggleModule
import me.bmax.upatch.util.ui.LocalSnackbarHost
import me.bmax.upatch.util.undoRemoveModule
import me.bmax.upatch.util.uninstallModule
...
fun APModuleScreen(navigator: DestinationsNavigator) {
    ...
    val state by UPApplication.apStateLiveData.observeAsState(UPApplication.State.UNKNOWN_STATE)
    if (state != UPApplication.State.ANDROIDPATCH_INSTALLED && state != UPApplication.State.ANDROIDPATCH_NEED_UPDATE) {
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(12.dp),
                    ...
                    onClickModule = { id, name, hasWebUi ->
                        if (hasWebUi) {
                            webUILauncher.launch(
                                ...
                                ).setData("upatch://webui/$id".toUri()).putExtra("id", id)
                                    .putExtra("name", name)
                            )
                        }
                    },
