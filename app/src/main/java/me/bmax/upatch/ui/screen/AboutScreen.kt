    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                FilledTonalButton(
                    onClick = { uriHandler.openUri(BuildConfig.SOURCE_REPO_URL) }
                ) {
                    Icon(
                ...
                FilledTonalButton(
                    onClick = { uriHandler.openUri(BuildConfig.CHANNEL_URL) }
                ) {
                    Icon(
            ...
            Row(
                ...
                FilledTonalButton(
                    onClick = { uriHandler.openUri(BuildConfig.WEBLATE_URL) }
                ) {
                    Icon(
                ...
                FilledTonalButton(
                    onClick = { uriHandler.openUri(BuildConfig.DISCUSSION_URL) }
                ) {
                    Icon(
                        painter = painterResource(id = R.drawable.telegram),
                        contentDescription = null
