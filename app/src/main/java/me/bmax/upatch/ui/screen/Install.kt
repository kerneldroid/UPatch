...
import me.bmax.upatch.ui.component.KeyEventBlocker
import me.bmax.upatch.ui.component.rememberCustomDialog
import me.bmax.upatch.util.hasMetaModule
import me.bmax.upatch.util.installModule
        ...
        AlertDialog(
            ...
            dismissButton = {
                OutlinedButton(onClick = {
                    uriHandler.openUri(BuildConfig.DOCS_URL.trimEnd('/') + "/meta-module.html")
                }) {
        ...
        TopBar(onBack = dropUnlessResumed {
            ...
            scope.launch {
                ...
                val file = File(
                    ...
                    "UPatch_install_${type}_log_${date}.log"
                )
