...
val managerAppName: String by rootProject.extra
val managerApplicationId: String by rootProject.extra
val managerArtifactName: String by rootProject.extra
val managerSourceRepoUrl: String by rootProject.extra
val managerIssuesUrl: String by rootProject.extra
val managerDocsUrl: String by rootProject.extra
val managerChannelUrl: String by rootProject.extra
val managerDiscussionUrl: String by rootProject.extra
val managerWeblateUrl: String by rootProject.extra
val managerUpdateApiUrl: String by rootProject.extra
val managerExpectedSignatureSha256: String by rootProject.extra
val managerEnforceSignatureVerification: Boolean by rootProject.extra
...
val baseFlags = listOf(
    ...
    "-fvisibility-inlines-hidden", "-fno-exceptions", "-fstack-protector-strong",
...
android {
            ...
            externalNativeBuild {
                cmake {
                    val relFlags = listOf(
                        ...
                        "-fno-semantic-interposition", "-fno-threadsafe-statics", "-Wl,-z,max-page-size=16384"
                    )
                    cppFlags += relFlags
                    cFlags += relFlags
    ...
    defaultConfig {
        ...
        if (androidTargetSdkPreview.isNotBlank()) {
            targetSdkPreview = androidTargetSdkPreview
        } else {
        ...
        buildConfigField("String", "buildKPV", quoteBuildConfig(kernelPatchVersion))
        buildConfigField("String", "APP_NAME", quoteBuildConfig(managerAppName))
        buildConfigField("String", "SOURCE_REPO_URL", quoteBuildConfig(managerSourceRepoUrl))
        buildConfigField("String", "ISSUES_URL", quoteBuildConfig(managerIssuesUrl))
        buildConfigField("String", "DOCS_URL", quoteBuildConfig(managerDocsUrl))
        buildConfigField("String", "CHANNEL_URL", quoteBuildConfig(managerChannelUrl))
        buildConfigField("String", "DISCUSSION_URL", quoteBuildConfig(managerDiscussionUrl))
        buildConfigField("String", "WEBLATE_URL", quoteBuildConfig(managerWeblateUrl))
        buildConfigField("String", "UPDATE_API_URL", quoteBuildConfig(managerUpdateApiUrl))
        buildConfigField("String", "EXPECTED_SIGNATURE_SHA256", quoteBuildConfig(managerExpectedSignatureSha256))
        buildConfigField("boolean", "ENFORCE_SIGNATURE_VERIFICATION", managerEnforceSignatureVerification.toString())
        base.archivesName = "${managerArtifactName}_${managerVersionCode}_${managerVersionName}_${branchName}"
    }
